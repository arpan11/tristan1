...
# Required Fields
gotob.SetMerchantId("123456")					# REQUIRED: Enter your merchant ID
gotob.SetMerchantPin("123456")					# REQUIRED: Enter your merchant Pin
gotob.SetIpAddress("12.12.12.12")				# REQUIRED: Pass in your internet facing IP Address
...
gotob.SetCcNumber( '4007000000027' )			# REQUIRED for CC Transactions
gotob.SetCcExpiration( '0118' )					# REQUIRED for CC Transactions
gotob.SetCcVerification( '123' )				# OPTIONAL
